...
const BenefitsSection = () => {
  return <section className="py-32 relative overflow-hidden">
      {/* Animated Background */}
      <motion.div className="absolute top-0 right-0 w-[1000px] h-[1000px] rounded-full blur-[200px]" style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          duration: 0.8
            ...
            <motion.span className="inline-block text-primary text-sm font-semibold tracking-wider uppercase mb-4" initial={{
            opacity: 0
          }} whileInView={{
            opacity: 1
          }} viewport={{
            ...
            <div className="space-y-6">
              {benefits.map((benefit, index) => <motion.div key={index} className="group flex items-start gap-5" initial={{
              opacity: 0,
              x: -30
            }} whileInView={{
              opacity: 1,
              ...
              delay: index * 0.1
                  ...
                  <motion.div className="relative w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 overflow-hidden" whileHover={{
                scale: 1.1,
                rotate: 5
              }} transition={{
                duration: 0.3
            ...
            delay: 0.5
              ...
              <Link to="/kontakt">
                ...
                scale: 0.98
                  ...
                  <Button size="lg" className="relative overflow-hidden text-lg px-8 py-6 rounded-full font-semibold group" style={{
                  background: 'linear-gradient(135deg, hsl(185 100% 50%) 0%, hsl(200 100% 60%) 100%)'
                }}>
          ...
          duration: 0.8
            ...
            <motion.div className="relative rounded-3xl p-8 border border-border/50 overflow-hidden" style={{
            ...
            ease: "easeInOut"
              ...
              {/* Glow Effect */}
              <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full blur-[80px]" style={{
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {statsData.map((stat, index) => <motion.div key={index} className="rounded-2xl p-5 border border-border/30" style={{
                  background: 'linear-gradient(145deg, hsl(222 47% 14%) 0%, hsl(222 47% 10%) 100%)'
                }} initial={{
                  opacity: 0,
                  scale: 0.9
                }} whileInView={{
                  ...
                  borderColor: 'hsl(185 100% 50% / 0.4)'
                      ...
                      <motion.p className="text-4xl font-display font-bold mb-1" style={{
                    background: 'linear-gradient(135deg, hsl(185 100% 50%) 0%, hsl(200 100% 65%) 100%)',
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent'
                  }}>
                ...
                {/* Activity Feed */}
                <div className="rounded-2xl p-5 border border-border/30" style={{
                background: 'linear-gradient(145deg, hsl(222 47% 12%) 0%, hsl(222 47% 9%) 100%)'
              }}>
                  ...
                  <div className="space-y-3">
                    ...
                    time: "vor 8 Min."
                  }].map((activity, i) => <motion.div key={i} className="flex items-center gap-3" initial={{
                    opacity: 0,
                    x: -20
                  }} whileInView={{
                    opacity: 1,
            ...
            {/* Decorative Elements */}
            <motion.div className="absolute -bottom-4 -right-4 w-32 h-32 rounded-2xl border border-primary/20 -z-10" animate={{
            rotate: [0, 5, 0]
          }} transition={{
            duration: 8,
            repeat: Infinity,
            ...
            <motion.div className="absolute -top-4 -left-4 w-24 h-24 rounded-full border border-primary/10 -z-10" animate={{
            scale: [1, 1.1, 1]
          }} transition={{
            duration: 6,
            repeat: Infinity,
